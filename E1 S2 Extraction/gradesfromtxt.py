...
for i in txtlist:
    if "S19" in i:
        ...
        eplab.append(i[-1:-2:-1])
    elif "CS1281" in i:
        oopslab.append(i[-1:-2:-1])
    elif "CS1282" in i:
        dslab.append(i[-1:-2:-1])
    elif "BE1201" in i:
        es.append(i[-1:-2:-1])
...
# wb = Workbook()
# ws = wb.active
for id,a,b,c,d,e,f,g,h,i in zip(ids,dms,ep,mefa,oops,ds,eplab,oopslab,dslab,es):
    # ws.append([id,a,b,c,d,e,f,g,h,i])
    print(id,a,b,c,d,e,f,g,h,i)
# wb.save("Grade.xlsx")
...
#         if(ids[i]==ids[j]):
#             duplets.append(ids[i])
#             print(ids[i])

# print("Total Length",len(ids))
# print("Duplicates Length",len(duplets))
# print("Without Length",len(duplets))
