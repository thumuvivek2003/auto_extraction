...
for i in a:
    if "ID" in i:
        grades[9].append(i[4:11])
    elif "MA1202" in i:
        grades[0].append(i[-1:-2:-1])
    elif "PY1201" in i:
        grades[1].append(i[-1:-2:-1])
    elif "BM1201" in i:
        grades[2].append(i[-1:-2:-1])
    elif "CS1201" in i:
        grades[3].append(i[-1:-2:-1])
    elif "CS1202" in i:
        grades[4].append(i[-1:-2:-1])
    elif "PY1281" in i:
        grades[5].append(i[-1:-2:-1])
    elif "CS1281" in i:
        grades[6].append(i[-1:-2:-1])
    elif "CS1282" in i:
        grades[7].append(i[-1:-2:-1])
    elif "BE1201" in i:
        grades[8].append(i[-1:-2:-1])
...
def gtogpa(grade):
    ...
    elif grade=="C":return 7
    elif grade=="D":return 6
    elif grade=="E":return 5
    elif grade=="R":return 4
from openpyxl import Workbook
wb = Workbook()
ws = wb.active
for i in range(len(grades[0])):
    # print(grades[9][i],grades[0][i],grades[1][i],grades[2][i],grades[3][i],grades[4][i],grades[5][i],grades[6][i],grades[7][i],grades[8][i])
    # ws.append([gtogpa(grades[9][i]),gtogpa(grades[0][i]),gtogpa(grades[1][i]),gtogpa(grades[2][i]),gtogpa(grades[3][i]),gtogpa(grades[4][i]),gtogpa(grades[5][i]),gtogpa(grades[6][i]),gtogpa(grades[7][i]),gtogpa(grades[8][i]])
    ws.append([grades[9][i],gtogpa(grades[0][i]),gtogpa(grades[1][i]),gtogpa(grades[2][i]),gtogpa(grades[3][i]),gtogpa(grades[4][i]),gtogpa(grades[5][i]),gtogpa(grades[6][i]),gtogpa(grades[7][i]),gtogpa(grades[8][i])])
    # print([grades[9][i],gtogpa(grades[0][i]),gtogpa(grades[1][i]),gtogpa(grades[2][i]),gtogpa(grades[3][i]),gtogpa(grades[4][i]),gtogpa(grades[5][i]),gtogpa(grades[6][i]),gtogpa(grades[7][i]),gtogpa(grades[8][i])])
wb.save("E1S2Points.xlsx")
